...
namespace llvm {
    ...
    public:
        enum class ExtractState { Complete,
            MoreItems };
        ...
        getAttributeValue(const uint64_t DIEOffset, const dwarf::Attribute Attr, const DWARFUnit& U) const;
        ...
        /// \returns Optional DWARF form value if the attribute was extracted.
        LLVM_ABI std::optional<DWARFFormValue>
        getAttributeValueFromOffset(uint32_t AttrIndex, uint64_t Offset, const DWARFUnit& U) const;
