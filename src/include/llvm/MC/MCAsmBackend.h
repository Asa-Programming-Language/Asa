...
namespace llvm {
    ...
    public:
        ...
        /// reported via \p Ctx.
        virtual void applyFixup(const MCFragment&, const MCFixup&, const MCValue& Target, MutableArrayRef<char> Data, uint64_t Value, bool IsResolved) = 0;
        ...
        virtual bool fixupNeedsRelaxationAdvanced(const MCFixup&, const MCValue&, uint64_t, bool Resolved) const;
