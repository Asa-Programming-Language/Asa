...
namespace llvm {
    ...
    public:
        ...
        {
            llvm_unreachable(
                "Re-mapping of section addresses not supported with this "
                "EE!");
        }
    ...
    public:
        ...
        selectTarget(const Triple& TargetTriple, StringRef MArch, StringRef MCPU, const SmallVectorImpl<std::string>& MAttrs);
